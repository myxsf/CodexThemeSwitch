...
/usr/bin/grep -q 'bundledEngineRelativePaths' "$ROOT/switcher/ThemeSwitcherApp.swift"
/usr/bin/grep -q 'resolvedThemeId' "$ROOT/switcher/ThemeSwitcherApp.swift"
/usr/bin/grep -q 'hasThemeMismatch' "$ROOT/switcher/ThemeSwitcherApp.swift"
/usr/bin/grep -q 'assets/renderer-inject.js' "$ROOT/switcher/ThemeSwitcherApp.swift"
/usr/bin/grep -q 'assets/dream-skin.css' "$ROOT/switcher/ThemeSwitcherApp.swift"
/usr/bin/grep -q 'assets/qq2007.css' "$ROOT/switcher/ThemeSwitcherApp.swift"
