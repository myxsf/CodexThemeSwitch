...
grep -q 'function Test-NodeRuntime' "$ROOT/scripts/common-windows.ps1"
grep -q 'function Install-LocalNodeRuntime' "$ROOT/scripts/common-windows.ps1"
grep -q 'CODEX_DREAM_SKIN_DENY_PACKAGE_NODE' "$ROOT/tests/release-install-smoke.ps1"
grep -q 'Package-blocked Node.js was not copied' "$ROOT/tests/release-install-smoke.ps1"
...
grep -q -- '--color-token-main-surface-primary: var(--dream-theme-panel)' "$ROOT/assets/dream-skin.css"
grep -q -- '--color-token-text-secondary: color-mix' "$ROOT/assets/dream-skin.css"
grep -q -- '--dream-on-accent:' "$ROOT/assets/dream-skin.css"
grep -q 'from-token-main-surface-primary' "$ROOT/assets/dream-skin.css"
